...
public class SchematicUploadConfirmScreen extends Screen {
    ...
    public SchematicUploadConfirmScreen(Path filePath) {
        super(new TranslatableComponent("createschematicupload.confirm.title"));
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(
                ...
                new TranslatableComponent("createschematicupload.confirm.upload"),
                button -> {
        ...
        this.addRenderableWidget(new Button(
                ...
                new TranslatableComponent("createschematicupload.confirm.cancel"),
                button -> this.onClose()
        ));
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredString(poseStack, this.font,
                new TranslatableComponent("createschematicupload.confirm.message", fileName),
