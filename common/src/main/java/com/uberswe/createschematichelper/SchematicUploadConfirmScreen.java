...
public class SchematicUploadConfirmScreen extends Screen {
    ...
    public SchematicUploadConfirmScreen(Path filePath) {
        super(new TranslatableComponent("createschematichelper.confirm.title"));
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(
                ...
                new TranslatableComponent("createschematichelper.confirm.upload"),
                button -> {
        ...
        this.addRenderableWidget(new Button(
                ...
                new TranslatableComponent("createschematichelper.confirm.cancel"),
                button -> this.onClose()
        ));
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredString(poseStack, this.font,
                new TranslatableComponent("createschematichelper.confirm.message", fileName),
